...
class SetPayloadRequest(genpy.Message):
  _md5sum = "6a2cd594b640cc49946d268b22a837bd"
...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_f3d().pack(_x.mass, _x.center_of_gravity.x, _x.center_of_gravity.y, _x.center_of_gravity.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mass, _x.center_of_gravity.x, _x.center_of_gravity.y, _x.center_of_gravity.z,) = _get_struct_f3d().unpack(str[start:end])
      return self
...
class SetPayload(object):
  ...
  _md5sum = '3e3a97c1edb6d0acdd0d0c9e9e4a538a'
